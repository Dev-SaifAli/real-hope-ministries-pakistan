...
const projects: Project[] = [
  ...
  },
  {
    ...
    image: '/projects/free-people.jpg',
  ...
  },
  {
    ...
    image: '/projects/persecution.jpg',
  ...
  return (
    <section className='w-full bg-white py-16 px-6 md:px-10'>
      <div className='text-center mb-10 max-w-2xl mx-auto'>
        <h2 className='text-navy font-display font-black text-[32px] md:text-[36px]'>
