  ...
  return (
    <section className='w-full bg-white  '>
      <div className='main-container'>
        <div className='grid grid-cols-1 xl:grid-cols-2 md:gap-8 xl:gap-26 md:items-stretch'>

          {/* ── Mission Card ── */}
          <div className='flex flex-col items-center mb-8 md:mb-0'>
            <div className='w-full h-2 sm:h-2.75 bg-navy' />
            <div className='flex flex-col gap-2 sm:gap-4 md:gap-6 pt-6 md:pt-10 w-full max-w-[90%] sm:max-w-[90%] flex-1'>
              <h2 className='font-display font-semibold text-black impact-heading'>
                Our Mission
              </h2>
              <p className='font-sans text-black impact-para h-auto   xl:h-48  overflow-hidden'>
