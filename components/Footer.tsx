...
const socialLinks = [
  ...
  { label: 'Twitter', href: 'https://x.com/MmDillshan', icon: '/icons/twitter.svg' },
  {
    label: 'Instagram',
...
export default function Footer () {
  return (
    <footer className='w-full bg-navy text-white'>
      {/* ── Main Footer Content ── */}
      <div className='max-w-480 mx-auto px-4 sm:px-6 md:px-20 py-12 md:py-16'>
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-12 items-start'>
          ...
          {footerColumns.map((column: FooterColumn) => (
            <div key={column.title} className='flex flex-col gap-3 sm:gap-4 md:gap-6 lg:gap-8  pl-20'>
              <h3 className='font-sans font-bold text-white text-[16px] sm:text-[18px]'>
                {column.title}
              </h3>
          ...
          <div className='flex flex-col gap-6 col-span-2 md:col-span-1 lg:ml-auto'>
            <h3 className='font-sans font-bold text-white text-[16px] sm:text-[18px]'>
              Contact with Us
            </h3>
      ...
      <div className='max-w-480 mx-auto px-4 sm:px-6 md:px-20'>
