  ...
  return (
    <section className='w-full bg-white py-8 sm:py-10 md:py-12 px-4  sm:px-6 md:px-10'>
      <div className='text-center px-4 sm:px-6 mb-7 sm:mb-8 md:mb-10 max-w-[900px] mx-auto'>
        <h2 className='font-display font-semibold text-navy text-2xl sm:text-4xl md:text-4xl leading-tight'>
          Our Ministries and <span className='text-green'>Projects</span>
        </h2>
      </div>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 md:gap-x-8 gap-y-6 sm:gap-y-8 md:gap-y-12 max-w-480 mx-auto'>
